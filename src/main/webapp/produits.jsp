        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          ...
          <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group mr-2">
		   		<a href="form-produit.jsp" class="btn btn-sm btn-primary">Enregistrer</a>        
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 pr-0 mb-3">
            <div class="card-collapsible card">
              <div class="card-header">
                Produits <i class="fa fa-caret-down caret"></i>
              </div>
              <div class="card-body">
                <table class="table">
                  ...
                  %>
                    <tr>
                      <td><%= sp.getLibelle()%></td>
                      <td>
                          <a class="btn btn-sm btn-success" href="modifierProduit?codeProduit=<%= sp.getCode()%>">Modifier</a>
