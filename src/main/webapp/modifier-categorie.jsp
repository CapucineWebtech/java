        ...
        <div class="col-lg-12 col-md-12 col-sm-12 pr-0 mb-3">
            <div class="card-collapsible card">
              <div class="card-header">
                Modifier une catégorie <i class="fa fa-caret-down caret"></i>
              </div>
              <div class="card-body">
                <form method="post" action="modifierCategorie">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Intitul� du produit" name="libelle" value="<%= categorie.getLibelle()%>">
                  </div>
                  <div class="form-group">
